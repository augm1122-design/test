...
<head>
    ...
    <title>MU-DORMS - female Dorm Listings</title>
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="male_dorms.php" data-translate="male dorms">male Dorms</a></li>
    ...
    <div class="main-image-container">
        ...
        <div class="image-overlay-content">
            <h1 data-translate="Find Your Perfect female Dorm!">Find Your Perfect female Dorm!</h1>
   ...
   <!-- قسم الفلاتر والترتيب -->
    <div class="filter-sort-container">
        ...
        <div class="filter-group">
            <div class="filter-dropdown">
                <button class="dropdown-btn" id="amenitiesBtn" data-translate="amenities">Amenities  <i class="fas fa-chevron-down"></i></button>
...
<a href="dorm_details.php?id=${dorm.dorm_id}">
    <img src="${dorm.image_url || 'https://via.placeholder.com/300x200?text=No+Image'}" alt="${dorm.name}">
            ...
            const getBotResponse = (userMessage) => {
                ...
                if (message.includes('إناث') || message.includes('male') || message.includes('بنات')) {
                    return lang === 'ar'
                        ? 'يمكنك الانتقال إلى صفحة سكنات الإناث من القائمة العلوية بالضغط على "Male Dorms". 👨'
                        : 'You can go to the male dorms page from the top menu by clicking "Male Dorms". 👨';
                }
